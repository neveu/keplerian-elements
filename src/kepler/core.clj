(ns kepler.core
  "Keplerian elements for calculating positions of planets"
...
(defn keplerian-element
  "a0, dadt : semi-major axis (au, au/century)
e0, dedt : eccentricity ([unitless], /century)
I0, dIdt : inclination (degrees, degrees/century)
L0, dLdt : mean longitude (degrees, degrees/century)
wbar0, dwbardt : longitude of perihelion (degrees, degrees/century)
omega0, domegadt : longitude of ascending node (degrees, degrees/century)
returns map of these arguments"
...
(defn- +-180 [n]
  "maps angle n to +/-180"
  (Math/IEEEremainder n 360))
(map +-180 [0 90 180 270 360 -90 -180 
(defn- radians [deg]
  (* deg (/ Math/PI 180.0)))
